        ...
        <Grid container spacing={16}>
          ...
          <Grid item xs={12} sm container>
            <Grid item xs container direction="column" spacing={16}>
              ...
              <Grid item>
                <Button onClick={this.handleClick} variant="outlined" color="secondary" className={classes.button}>Remove</Button>
              </Grid>
            </Grid>
            <Grid container item xs direction="row" spacing={8}>
              ...
              <Grid
                ...
                <TextField
                  ...
                  variant="standard"
                />
                <Typography variant="subtitle1">${(price*quantity).toFixed(2)}</Typography>
              </Grid>
            </Grid>
          </Grid>
        </Grid>
